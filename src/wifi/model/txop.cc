...
void
Txop::SetTfAccessGrantCallback (Callback<void> callback)
{ 
  NS_LOG_FUNCTION (this << &callback);
...
void
Txop::CancelTFRespIfNotSent (void)
{
...
void 
Txop::SetMuMode (bool muMode)
{
  m_muMode = muMode;
}

bool 
Txop::GetMuMode (void) const
{
  return m_muMode;
}

void 
Txop::SetRuBits (uint32_t ruBits)
{
  m_ruBits = ruBits;
}

uint32_t 
Txop::GetRuBits (void) const
{
  return m_ruBits;
}
